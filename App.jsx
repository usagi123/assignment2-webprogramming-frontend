        ...
        return (
                    ...
                    <br/>
                        ...
                        <li><table><tbody>
                            ...
                            <a href="#" onClick={(e)=>{
                                ...
                                <img src="/icons/detail.png" width="25px" height="25px" /></a>
                                </td>
                                <td>
                                <button disabled={product.exist>0?'':'disable'}
                                  onClick={() => {
                                    let newState = {}
                                    ...
                                    } ><img className='icon'  width ='25px' height = '20px' src='./icons/cart.png'/></button>
                                </td>
                                </tr>
                                </tbody></table>
                        </li>
            ...
            <div className="right">
                    ...
                    <table style={{ width:"50%",borderWidth:"2px", borderColor:"#dddddd"}}>
                        ...
                        <tr>
                            <td>Price</td>
                            <td><input type="number" name='price' value={this.state.price}
                            onChange={this.handleChange.bind(this)} /></td>
                        </tr>
                        <tr>
                            <td>Description</td>
