...
function updateCategory(categories) {
    return function (dispatch) {
        fetch('https://a2-webpro-s3-2017.herokuapp.com/categories/' + categories._id, {
            method: 'PUT',
            headers: {
                'Content-type': 'application/json',
                'Accept': 'application/json'
...
function addOrder(orders) {
    return function (dispatch) {
        fetch("https://a2-webpro-s3-2017.herokuapp.com/orders", {
            ...
            return dispatch({ type: 'ADD_ORDER_SUCCESS',
                payload: data });
        });
    };
}
...
function addToCart(products) {
    return function (dispatch) {
        fetch("https://a2-webpro-s3-2017.herokuapp.com/shoppingcarts", {
            method: 'POST',
            headers: {
                'Content-type': 'application/json',
                'Accept': 'application/json'
...
function fetchCarts() {
    return function (dispatch) {
        fetch('https://a2-webpro-s3-2017.herokuapp.com/shoppingcarts').then(function (res) {
            return res.json();
        }).then(function (data) {
            dispatch({
...
function deleteCart(id) {
    return function (dispatch) {
        fetch('https://a2-webpro-s3-2017.herokuapp.com/shoppingcarts/' + id, {
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
            },
                                            ...
                                            _react2.default.createElement(
                                                ...
                                                _react2.default.createElement(
                                                    ...
                                                    _react2.default.createElement(
                                                        ...
                                                        _react2.default.createElement('img', { src: '/icons/detail.png', width: '25px', height: '25px' })
                                                    )
                                                ),
                                                _react2.default.createElement(
                                                    'td',
                                                    ...
                                                    _react2.default.createElement(
                                                        ...
                                                        { disabled: product.exist > 0 ? '' : 'disable',
                                                            onClick: function onClick() {
                                                                ...
                                                                var updateState = { _id: product._id, id: product.id, name: product.name, price: product.price, description: product.description, brand: product.brand, producer: product.producer,
                                                                    exist: product.exist, imageUrl: product.imageUrl };
                                                                _this2.props.dispatch((0, _main.updateProduct)(updateState));
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'td',
                                    null,
                                    _react2.default.createElement('input', { type: 'number', name: 'price', value: this.state.price,
                                        onChange: this.handleChange.bind(this) })
                                )
                            ),
                            _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'a',
                                        { type: 'button', className: 'button', value: 'Save', onClick: function onClick() {
                                                return _this2.handleSave();
                                            } },
                                        _react2.default.createElement('img', { src: '/icons/submit.png', width: '25px', height: '25px', alt: '' })
                                    )
                                )
                            )
                        )
...
var Order = function (_React$Component) {
    ...
    _createClass(Order, [{
        ...
        key: 'handleSave',
        value: function handleSave() {
            if (this.state.id === '' || this.state.name === '' || this.state.email === '' || this.state.phone === '' || this.state.address === '' || this.state.orderDate === '' || this.state.total === '') {
                alert('Please check the form');
                return false;
            } else {
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'select',
                                    { name: 'status', value: this.state.status, onChange: this.handleChange.bind(this) },
                                    _react2.default.createElement(
                                        'option',
                                        null,
                                        'New'
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    currentPath.includes('/about') ? _react2.default.createElement(_About2.default, null) : currentPath.includes('/changeView') ? _react2.default.createElement(_ChangeView2.default, { dispatch: this.props.dispatch, products: this.props.products }) : currentPath.includes('/categories') ? _react2.default.createElement(_Categories2.default, { dispatch: this.props.dispatch, categories: this.props.categories, editedCategory: this.props.editedCategory }) : currentPath.includes('/order') ? _react2.default.createElement(_Order2.default, { dispatch: this.props.dispatch, orders: this.props.orders, editedOrder: this.props.editedOrder, carts: this.props.carts }) : currentPath.includes('/shoppingcart') ? _react2.default.createElement(_ShoppingCart2.default, { dispatch: this.props.dispatch, products: this.props.products, carts: this.props.carts }) : _react2.default.createElement(_App2.default, { dispatch: this.props.dispatch, products: this.props.products, editedProduct: this.props.editedProduct, editedProductToAdd: this.props.editedProductToAdd,
...
var ShoppingCart = function (_React$Component) {
    ...
    _createClass(ShoppingCart, [{
        ...
        value: function handleCheckOut() {
            ...
            var money = 0;
            this.props.carts.map(function (i) {
                money = money + parseInt(i.price);
                _this2.props.dispatch((0, _main.deleteCart)(i._id));
            });
            var bill = {};
            bill['total'] = money;
            this.props.dispatch((0, _main.addOrder)(bill));
        }
    }, {
        key: 'handleDeleteAll',
        value: function handleDeleteAll() {
            ...
            if (confirm('Are you sure to DELETE ALL of the items?')) {
                this.props.carts.map(function (i) {
                    return _this3.props.dispatch((0, _main.deleteCart)(i._id));
                });
            }
        }
    }, {
                            ...
                            return _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'a',
                                        { onClick: function onClick() {
                                                return _this4.handleDelete(cart._id);
                                            } },
                                        _react2.default.createElement('img', { className: 'icon', src: './icons/rubbish-bin.png' })
                                    )
                                ),
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        { href: '#', onClick: function onClick() {
                                                var order = { total: cart.price, imageUrl: cart.imageUrl };
                                                _this4.props.dispatch((0, _main.deleteCart)(cart._id));
                                                _this4.props.dispatch((0, _main.addOrder)(order));
                                            } },
                                        'Check_Out'
                                    )
                                )
